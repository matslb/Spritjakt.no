...
import config from "../configs/vmp.js";
...
class VmpClient {
            ...
            products = products.concat(
                await axios(options)
                    .then(async function (res) {
                        ...
                        let new_products = ProductSearchParser.GetProductsFromSearchResult(res.data);
    ...
    static async GetNewProductList() {
        return await this.GetProductsFromSearch(
            "https://www.vinmonopolet.no/vmpws/v2/vmp/products/search?fields=FULL&pageSize=24&currentPage=0&q=%3Arelevance%3AnewProducts%3Atrue",
            true
        );
    }
