...
function NewProductUpdateRecord(productData, stores, year, vintageComment) {
    return {
        AvailableOnline:
...
export default class ProductSearchParser {
    ...
    static GetProductsFromSearchResult = (jsonData) => {
        return (jsonData.products || []).map((productData) =>
