...
class ProductComp extends React.Component {
  ...
  render() {
    ...
    let priceIsLower =
      showDiff &&
      product.LatestPrice < product.PriceHistory[product.PriceHistorySorted[1]];
    return (
      <li
        id={product.Id}
        className={
          "MiniProduct " + (priceIsLower ? "price_lowered" : "price_raised")
        }
      >
        {showDiff && (
        ...
        <button
          ...
          onClick={() => this.props.highlightProduct(product.Id)}
          className="img"
          style={background}
        ></button>
        <div
        ...
        <div style={{ textAlign: "center" }}>
          <button
            ...
            onClick={(e) => {
              ...
              this.props.notification.current.setNotification(
                e,
                "Fjernet",
                "success"
              );
