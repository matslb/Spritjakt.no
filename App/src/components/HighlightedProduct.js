...
import {faExternalLinkAlt, faHeart, faLink, faSeedling, faWineBottle,} from "@fortawesome/free-solid-svg-icons";
    ...
    return (
      ...
      <span className="productWatchBtns">
        {isFavorite && (
          ...
          {product.Type ?? (product.Types?.length >= 1 ? product.Types[product.Types.length - 1] : "")},{" "}
                    {product.Country}
                    <br/>
