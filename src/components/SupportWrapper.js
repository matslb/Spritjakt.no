...
const SupportWrapper = () => {
  return (
    <section className="SupportWrapper ">
      ...
      <p>
        Hvis du syns dette er en kul tjeneste så hadde jeg satt uhorvelig stor
        pris på en donasjon eller et lite kjøp. <br />
        Da kan jeg fortsette utviklingen og holde tjenesten gratis!
      </p>
      <div className="content">
        <article className="vipps">
          ...
          {isMobile ? (
            <a
              href="https://qr.vipps.no/28/2/05/031/kix5KzyDM"
              rel="noopener noreferrer"
              className="clickable vipps"
            >
              Støtt meg på Vipps
            </a>
          ) : (
        ...
        <article>
          ...
          <p>
            Du får noe stilig stæsj, og jeg får en slant som vil hjelpe med
            vedlikehold og hosting
          </p>
          <img
            loading={"lazy"}
            src="https://spritjakt.no/images/productimages.jpg"
            alt="produktbilder"
            width="400px"
          />
          <a className="clickable" href="https://butikk.spritjakt.no">
            Sjekk ut Spritjaktbutikken
          </a>
        </article>
      </div>
    </section>
