    ...
    <div>
      ...
      <div className="notificationSection">
        <div>
          ...
          <label>
            <input type="checkbox" name="onAll" /> Alle prisendringer
          </label>
          <br />
          <label>
            <input type="checkbox" name="onFilters" /> Prisendringer i lagrede
            filtre
          </label>
          <br />
          <label>
            <input type="checkbox" name="onFavorites" /> Prisendringer i
            favoritter
          </label>
          <br />
        </div>
        <div>
          <h4>Varsle meg på...</h4>
          <label>
            <input type="checkbox" name="byPush" /> Push-varsler
          </label>
          <br />
          <label>
            <input type="checkbox" name="byEmail" /> E-post
          </label>
        </div>
      </div>
    </div>
