  ...
  render() {
    ...
    return (
      <div className={"loginPage " + (formType !== null ? " active " : "")}>
        {!user && !userData && (
          <div
            onClick={() => this.setFormType(formTypes.login)}
        ...
        {formType !== null && (
          <div
            className={"loginSection " + (provider !== null ? " active " : "")}
          >
            {provider === null && (
                ...
                {formType !== formTypes.login ? (
                  <div className="switchLoginNotice">
                    ...
                    <button
                      className="link"
                      onClick={() =>
                        this.setFormType(formTypes.login, providers.email)
                      }
                    >
                      Logg inn
                    </button>
                  ...
                  <div style={{ textAlign: "center" }}>
                    ...
                    <div className="switchLoginNotice">
                      ...
                      <button
                        className="link"
                        onClick={() =>
                          this.setFormType(formTypes.register, providers.email)
                        }
                      >
                        Registrer deg
                      </button>
